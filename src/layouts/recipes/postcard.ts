...
export const postcard = {
  ...
  photos: [
    {
      ...
      placement: {
        desktop: { top: "11%", left: "10%", width: "62%", height: "44%", rotate: -4, z: 5 },
        mobile: {
          top: "14%",
          left: "5%",
          width: "82%",
  ...
  message: {
    variant: "postcard",
    placement: {
      desktop: { bottom: "8%", right: "8%", width: "72%", height: "40%", rotate: 3, z: 6 },
      mobile: {
        bottom: "10%",
        right: "5%",
        width: "86%",
  ...
  decorations: [
    {
      ...
      placement: {
        desktop: { bottom: "2%", left: "6%", width: "37%", rotate: -5, z: 9 },
        mobile: {
          bottom: "2.5%",
          left: "5%",
          width: "46%",
