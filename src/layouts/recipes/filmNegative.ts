...
export const filmNegative = {
  ...
  photos: [
    {
      ...
      variant: "film",
      placement: {
        desktop: { top: "12%", left: "5%", width: "44%", height: "27%", rotate: -4, z: 5 },
    ...
    },
    {
      ...
      variant: "film",
      placement: {
        desktop: { top: "9%", right: "5%", width: "44%", height: "27%", rotate: 4, z: 6 },
    ...
    },
    {
      ...
      placement: {
        desktop: { top: "32%", left: "28%", width: "46%", height: "27%", rotate: -1, z: 7 },
  ...
  message: {
    variant: "letter",
    placement: {
      desktop: { bottom: "6%", left: "11%", width: "78%", height: "40%", rotate: 1, z: 8 },
  ...
  decorations: [
    {
      kind: "film",
      placement: {
        desktop: { top: "44%", left: "4%", width: "29%", height: "6%", rotate: 7, z: 3 },
